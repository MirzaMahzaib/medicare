<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('product_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.products.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/products") || request()->is("admin/purchases/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-capsules c-sidebar-nav-icon"></i>
                    Medicines
                </a>
            </li>
        @endcan
        @can('purchase_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.purchases.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/purchases") || request()->is("admin/purchases/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-store c-sidebar-nav-icon"></i>
                    Purchases
                </a>
            </li>
        @endcan
